...
const DEFAULT_SETTINGS = { locations: [], genres: [], materialTypes: [], curatedShelves: [], formats: [], bindings: [], patrons: [], subscriptions: [], holds: [], circulationRules: [], acquisitionOrders: [], pendingMaterials: [], donationBatches: [], visitorCounts: {}, visitorLog: [], referenceCounts: {}, outgoingIllTransactions: [], incomingIllTransactions: [], registerTransactions: [], patronFees: [], receiptSettings: { showLogo: false, logoUrl: "", contactInfo: "", footerMessage: "" } };
